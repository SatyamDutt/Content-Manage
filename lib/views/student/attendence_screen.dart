  ...
  void addAttendence() async {
    ...
    try {
      await FirebaseFirestore.instance
          .collection('Students')
          .doc(widget.userId)
          .collection("Attendence").doc(className).collection(widget.subjectName)
          .add({
                      ...
                      children: [
                        ListTile(
                          ...
                          leading: Radio<Attendence>(
                              ...
                              groupValue: _character,
                              onChanged: _isDisabled ? null : (Attendence? value) {
                                setState(() {
                                  _character = value;
                                });
                              }),
      ...
      return Table(
        ...
        children: [
          ...
          ...snapshot.data!.docs.map((doc) {
            ...
            Timestamp? createdAt = doc["CreatedAt"] is Timestamp ? doc["CreatedAt"] : null;
              ...
              children: [
                Center(
                  child: Padding(
                    ...
                    child: Text(
                      createdAt != null
                          ? DateFormat('dd-MM-yyyy').format(createdAt.toDate()) // ✅ Convert Timestamp to Date
                          : "N/A", // ✅ Handle missing data
                    ),
                  ),
                ),
                Center(
                  child: Text(doc["Attendence Status"] ?? "Unknown"), // ✅ Handle missing status
                ),
              ],
            );
          }).toList(),
